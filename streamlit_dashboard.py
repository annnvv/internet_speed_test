...
fig, ax = plt.subplots()
ax.bar(avg_speeds_per_day['date'], avg_speeds_per_day['download_speed_Mb'])
ax.set_title('Average Download Speed per Day')
ax.set_xlabel('Date')
...
fig, ax = plt.subplots()
ax.bar(avg_speeds_per_day['date'], avg_speeds_per_day['upload_speed_Mb'])
ax.set_title('Average Upload Speed per Day')
ax.set_xlabel('Date')
ax.set_ylabel('Average Upload Speed (Mbps)')
plt.xticks(rotation=45)
ax.grid(axis='y')
